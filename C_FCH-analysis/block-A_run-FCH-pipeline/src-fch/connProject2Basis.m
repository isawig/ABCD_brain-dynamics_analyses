...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [alpha] = connProject2Basis(pattern, basis, invert)
...
if invert
    for i=1:nr_modes
        ...
        alpha(i) = max(dot(pattern, basis(:,i)), dot(pattern, -basis(:,i)));

    end
else
    for i=1:nr_modes

        alpha(i) = dot(pattern, basis(:,i));
